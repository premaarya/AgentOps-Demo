...
const TOOL_HINTS: Record<string, string> = {
	upload_contract:
		'{"text": "This Non-Disclosure Agreement between Acme Corp and Beta Inc..."}',
	classify_document:
		'{"text": "This Non-Disclosure Agreement between Acme Corp and Beta Inc..."}',
	extract_metadata:
		'{"text": "Agreement between Acme Corp and Beta Inc effective Jan 15 2026..."}',
	extract_clauses:
		'{"text": "Confidentiality: Each party agrees to keep all proprietary information confidential..."}',
	identify_parties:
		'{"text": "between Acme Corp (Disclosing Party) and Beta Inc (Receiving Party)"}',
	extract_dates_values:
		'{"text": "effective January 15, 2026... amount not to exceed $500,000"}',
	check_policy:
		'{"clauses": [{"type":"liability","text":"Liability shall not exceed $1M"}]}',
	flag_risk:
		'{"clauses": [{"type":"liability","text":"Liability shall not exceed $1M"}]}',
	get_policy_rules: "{}",
	check_clause_compliance:
		'{"clause": {"type":"confidentiality","text":"..."},"policy":"standard"}',
	validate_jurisdiction: '{"jurisdiction": "US-CA", "contract_type": "NDA"}',
	check_regulatory_requirements:
		'{"contract_type": "NDA", "jurisdiction": "US-CA"}',
	route_approval: '{"contract_id": "NDA-001", "risk_level": "medium"}',
	escalate_to_human:
		'{"contract_id": "NDA-001", "reason": "Liability exceeds threshold"}',
	notify_stakeholder:
		'{"contract_id": "NDA-001", "stakeholder": "legal@acme.com"}',
	get_audit_trail: '{"contract_id": "NDA-001"}',
	log_event:
		'{"contract_id": "NDA-001", "event": "reviewed", "agent": "compliance"}',
	generate_report: '{"contract_id": "NDA-001"}',
	run_evaluation:
		'{"contract_id": "NDA-001", "metrics": ["accuracy","completeness"]}',
	...
	get_drift_history: "{}",
	submit_feedback:
		'{"contract_id": "NDA-001", "agent": "extraction", "rating": 4, "comment": "Good"}',
...
export function BuildConsole() {
	...
	async function handleExecute() {
		try {
			...
			await post("/tools/" + selectedServer + "/" + selectedTool, {
				input: parsed,
			});
		} catch {
			/* input parsing error */
			...
			<div className="console-panels">
				...
				>
					...
					<button
						...
						disabled={
							loading || !currentServer || currentServer.status === "offline"
						}
					...
					{error && (
						<p className="text-sm" style={{ color: "var(--color-fail)" }}>
							{error}
						</p>
					)}
				</div>
			...
			{currentServer && (
				...
				>
					<div className="card-header">
						Tool Registry ({currentServer.name}) — {currentServer.status}
					</div>
					<div
						style={{
							display: "flex",
