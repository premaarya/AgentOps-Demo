...
describe("Dynamic Policy Engine", () => {
  ...
  describe("flagRisk", () => {
    it("returns critical risk for critical violations", async () => {
      const clauseResults = [
        { clause_type: "indemnification", status: "fail", policy_ref: "FIN-003", reason: "Unlimited indemnification", severity: "critical" as const },
        { clause_type: "liability", status: "fail", policy_ref: "FIN-001", reason: "Exceeds cap", severity: "high" as const },
      ];
    ...
    it("returns low risk when all clauses pass", async () => {
      const clauseResults = [
        { clause_type: "payment", status: "pass", policy_ref: "", reason: "No violations" },
      ];
