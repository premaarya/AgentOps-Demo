...
function simulateEvalRun(version: string): EvaluationResult {
  ...
  return {
    ...
    per_contract: {},
    quality_gate: (passed / totalCases) >= 0.80 && judgeScores.relevance >= 4.0 ? "PASS" : "FAIL",
