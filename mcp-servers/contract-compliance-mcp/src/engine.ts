import { type PolicyRule, PolicyViolation, policyEngine } from "./policyEngine.js";
...
export async function checkPolicy(clauses: ClauseInput[], _contractType?: string): Promise<ComplianceResult> {
